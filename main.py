...
async def process_with_gemini(messages: List[Dict[str, str]]) -> Optional[str]:
    try:
        ...
        system_message = {
            "role": "system",
            "content": "Pastikan semua respons point penting saja dalam Bahasa Indonesia yang mudah dipahami."
        }
        ...
        last_message = "Pastikan respons singkat padat jelas point pentingnya dalam Bahasa Indonesia. " + messages[-1]['content']
